...
| ------------- | ------------- | ------------- |
| protocol_18S_PCR  | 1.0.0  | 2022-04-25  |
...
### Sequencing
 ...
 1. The pooled product for the genetic locus was loaded on a standard MiSeq v2 flow cell and sequenced in a 2x150bp paired end format using a v2 500-cycle MiSeq reagent cartridge.
 2. The MiSeq run was performed with a 10% PhiX spike added.
 ...
 4. Base calling was done by Illumina Real Time Analysis (RTA) v1.18.54 and output of RTA was demultiplexed and converted to FastQ format with Illumina Bcl2fastq v2.18.0
 5. 18S rRNA Sequencing primers (5’ to 3’ direction):
 ...
 6. Sequencing is performed at the Research Technology Support Facility (RTSF) Genomics Core at Michigan State University (MSU).
